...
import { Moon, Sun, Bell, User, Menu, X, Globe, Code2 } from 'lucide-react';
...
const Navbar = ({ children }: { children: React.ReactNode }) => {
  ...
  return (
    <div className={`min-h-screen ${isDark ? 'dark bg-gray-900' : 'bg-gray-50'}`}>
      ...
      <header className="border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 dark:bg-gray-800 sticky top-0 z-50 shadow-sm">
      ...
      <footer className="bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700 mt-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {/* Add footer links or info here if needed */}
          </div>
